                      ...
                      <form action="#" method="POST" className="mt-3">
                            <div className="space-y-2">
                                <div>
                                    <label for="" className="text-sm font-bold text-gray-900"> Nom  Categorie</label>
                                    <div className="mt-1">
                                        <input type="text" defaultValue={state.categorieupdate.nom} name="" id="" placeholder="Lait de coco" className="block w-full px-4 py-3 placeholder-gray-500 border -gray-300 rounded-lg focus:ring-indigo-600 focus:border-indigo-600 sm:text-sm caret-indigo-600"
                                        onChange={(e)=>{state.categorieupdate.nom=e.target.value}}
                                        />
                                    </div>
                                </div>
                                ...
                                <label for="" class="block text-sm font-bold text-gray-900"> Description </label>
                                    <div class="mt-1">
                                        <textarea name="" defaultValue={state.categorieupdate.description}  id="" placeholder="Decrire un produit " rows="3" class="border block w-full px-4 py-3 placeholder-gray-500 border-gray-300 rounded-lg resize-y focus:ring-indigo-600 focus:border-indigo-600 sm:text-sm caret-indigo-600"
                                        onChange={(e)=>{state.categorieupdate.description=e.target.value}}>
                                        </textarea>
                                    </div>
                                </div>
                            </div>
